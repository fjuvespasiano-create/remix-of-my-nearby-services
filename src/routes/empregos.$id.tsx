  ...
  notFoundComponent: () => (
    <SiteLayout>
      <div className="container mx-auto max-w-md px-4 py-20 text-center">
        ...
        <Link to="/empregos" search={{}}><Button className="mt-6">Ver outras vagas</Button></Link>
      </div>
    </SiteLayout>
  ),
  ...
  return (
    <SiteLayout>
      <article className="container mx-auto max-w-3xl px-4 py-10">
        <Link to="/empregos" search={{}} className="mb-6 inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
...
function ApplyCTA({ job }: { job: JobDetail }) {
  ...
  return (
    <div className="mt-8 flex flex-wrap gap-3">
      ...
      <Link to="/empregos" search={{}}><Button variant="outline" size="lg">Ver outras vagas</Button></Link>
    </div>
  );
}
